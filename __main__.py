...
def _validate_forecast_arg(args):
...
unit_values = [name.title() for name, value in Unit__members__.items()]

argparser.add_argument('-u', '--unit', choices=unit_values, required=False, dest='unit', help=('Specify the unit that will be used to display the temperatures.'))

required.add_argument('-a', '--areacode', required=True, dest='area_code', help=('The area code to get the weather broadcast from. Can be obtained at https://weather.com'))
